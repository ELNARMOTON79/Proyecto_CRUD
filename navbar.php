    ...
    <nav class="bg-green-500 text-white">
        ...
        <div id="mobile-menu" class="hidden md:hidden">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                <a href="logins/login.php" class="text-white block px-3 py-2 rounded-md text-base font-medium hover:bg-green-700 transition duration-500 ease-in-out <?php echo is_active('logins/login.php'); ?>">
