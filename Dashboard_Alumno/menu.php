<div class="flex flex-col bg-green-500 fixed h-screen justify-between w-64 py-4 px-2">
    ...
    <div class="flex flex-col flex-auto">
        ...
        <div class="p-2 hover:bg-green-700 text-white rounded-md transition duration-500 ease-in-out">
            ...
            <div id="submenuCalificaciones" class="ml-6 mt-2 hidden">
                <a href="?action=listar_Calificaciones" class="block text-white hover:text-black rounded-md transition duration-500 ease-in-out">
                    <i class="fa-solid fa-clipboard-list"></i>
                    List Ratings
                </a>
            </div>
